...
const HomePage = () => {
  return (
   <div>
    <header className="u-clearfix u-header u-header" id="sec-2fdd">
  ...
  <section className="u-align-left u-clearfix u-section-1" id="carousel_7a98">
    <div className="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
      <div
        className="u-shape u-shape-svg u-text-palette-2-base u-shape-1"
          ...
          <div className="u-layout-row">
            <div className="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
              <div className="u-container-layout u-valign-top-lg u-valign-top-xl u-container-layout-1">
                <h1
                  className="u-custom-font u-font-ubuntu u-text u-text-1"
                  data-animation-name="fadeIn"
                  data-animation-duration={1000}
                ...
                <p className="u-text u-text-2">
                  Ullamcorper malesuada proin libero nunc. Id semper risus in
                  hendrerit gravida. Vulputate{" "}
                  <a
                    href="https://nicepage.com/web-design"
                    className="u-active-none u-border-1 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-1"
                  >
                    sapien nec
                  </a>{" "}
                ...
                <p className="u-text u-text-default u-text-3">
                  ...
                  <a
                    ...
                    className="u-active-none u-border-1 u-border-active-palette-2-base u-border-black u-border-hover-palette-2-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-2"
                  >
                    Freepik
                  </a>
                </p>
                <a
                  ...
                  className="u-active-grey-90 u-border-none u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-hover-grey-90 u-palette-2-base u-radius-50 u-text-active-white u-text-body-alt-color u-text-hover-white u-btn-3"
                >
                  View Menu
                </a>
              </div>
            </div>
            <div className="u-align-right u-container-style u-layout-cell u-size-30 u-layout-cell-2">
        ...
        <div className="u-gallery-inner u-gallery-inner-1">
          <div className="u-effect-fade u-effect-hover-zoom u-gallery-item u-shape-rectangle">
            ...
            >
              <img
                ...
                src="images/greek-salad-with-fresh-tomato-cucumber-red-onion-basil-feta-cheese-black-olives-italian-herbs_2829-4480.jpg"
              />
            </div>
          ...
          <div className="u-effect-fade u-effect-hover-zoom u-gallery-item u-shape-rectangle">
            ...
            >
              <img
                className="u-back-image u-expanded"
                src="images/fresh-vegetable-greek-salad-close-up_2829-19508.jpg"
              />
            </div>
          ...
          <div className="u-effect-fade u-effect-hover-zoom u-gallery-item u-shape-rectangle">
            ...
            >
              <img
                className="u-back-image u-expanded"
                src="images/man-cooking-fresh-vegetables-pan_1220-3199.jpg"
              />
            </div>
          ...
          <div className="u-effect-fade u-effect-hover-zoom u-gallery-item u-shape-rectangle">
            <div className="u-back-slide">
              <img
                className="u-back-image u-expanded"
                src="images/tortilla-wrap-with-falafel-fresh-salad-vegan-tacos-vegetarian-healthy-food_2829-6193.jpg"
              />
            </div>
            <div className="u-over-slide u-over-slide-4">
              <h3 className="u-gallery-heading" />
              <p className="u-gallery-text" />
            </div>
          </div>
      ...
      >
        <div className="u-container-layout u-container-layout-1">
          ...
          <a
            ...
            className="u-active-grey-90 u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-hover-grey-90 u-palette-2-base u-radius-50 u-text-active-white u-text-body-alt-color u-text-hover-white u-btn-1"
          >
            Learn more
          </a>
        </div>
  ...
  >
    ...
    <div className="u-list u-list-1">
      <div className="u-repeater u-repeater-1">
        ...
        <div className="u-align-left u-container-style u-grey-80 u-list-item u-opacity u-opacity-55 u-repeater-item u-shape-rectangle u-list-item-3">
        ...
        <div className="u-align-left u-container-style u-grey-80 u-list-item u-opacity u-opacity-55 u-repeater-item u-shape-rectangle u-list-item-3">
          <div className="u-container-layout u-similar-container u-valign-top u-container-layout-5">
            ...
            >
              <div className="u-container-layout u-valign-middle u-container-layout-6">
                <h1 className="u-custom-font u-text u-text-7">04</h1>
              </div>
            </div>
            <h5
              className="u-text u-text-body-alt-color u-text-8"
            ...
            <p className="u-text u-text-grey-30 u-text-12">
              Sample text. Click to select the text box. Click again or double
              click to start editing the text.
            </p>
            <a
        ...
        <div className="u-align-left u-container-style u-grey-80 u-list-item u-opacity u-opacity-55 u-repeater-item u-shape-rectangle u-list-item-3">
          <div className="u-container-layout u-similar-container u-valign-top u-container-layout-5">
            ...
            >
              <div className="u-container-layout u-valign-middle u-container-layout-6">
                <h1 className="u-custom-font u-text u-text-7">05</h1>
              </div>
            </div>
            <h5
              className="u-text u-text-body-alt-color u-text-8"
        ...
        <div className="u-align-left u-container-style u-grey-80 u-list-item u-opacity u-opacity-55 u-repeater-item u-shape-rectangle u-list-item-3">
          <div className="u-container-layout u-similar-container u-valign-top u-container-layout-5">
            ...
            >
              <div className="u-container-layout u-valign-middle u-container-layout-6">
                <h1 className="u-custom-font u-text u-text-7">06</h1>
              </div>
            </div>
            <h5
              className="u-text u-text-body-alt-color u-text-8"
    ...
    <p className="u-align-center u-text u-text-grey-30 u-text-19">
      Image by{" "}
      <a
        href="https://www.freepik.com/photos/frame"
        className="u-border-1 u-border-white u-btn u-button-style u-none u-text-grey-30 u-btn-7"
      >
        Freepik
      </a>
    </p>
  </section>
  <section className="u-clearfix u-grey-10 u-section-4" id="carousel_3cf9">
    <div
    ...
    >
      <div className="u-container-layout u-container-layout-1">
        ...
        <p className="u-text u-text-2">
          Id faucibus nisl tincidunt eget nullam non nisi. Amet dictum sit amet
          justo donec enim diam vulputate ut. Non quam lacus suspendisse
        ...
        <p className="u-text u-text-3">
          ...
          <a
            ...
            className="u-border-1 u-border-active-palette-2-base u-border-black u-border-hover-palette-2-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-none u-text-body-color u-btn-1"
            target="_blank"
          >
            Freepik
          </a>
        ...
        <a
          ...
          className="u-active-grey-90 u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-hover-grey-90 u-palette-2-base u-radius-50 u-text-active-white u-text-body-alt-color u-text-hover-white u-btn-2"
        >
          learn more
        </a>
      </div>
  ...
  >
    <div className="u-clearfix u-sheet u-sheet-1">
      ...
      <p className="u-text u-text-body-alt-color u-text-default u-text-3">
        ...
        <b>
          <a
            href="https://www.freepik.com/photos/delivery"
            className="u-border-1 u-border-active-white u-border-hover-white u-border-no-left u-border-no-right u-border-no-top u-border-palette-2-base u-btn u-button-link u-button-style u-none u-text-body-alt-color u-btn-1"
            target="_blank"
          >
            Freepik
          </a>
      ...
      <a
        href="https://nicepage.cc"
        className="u-border-none u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-palette-2-base u-radius-50 u-text-active-palette-2-light-3 u-text-body-alt-color u-text-hover-palette-2-light-3 u-btn-2"
      >
        View menu
      </a>
    </div>
  </section>
  <section className="u-align-center u-clearfix u-section-6" id="carousel_bc6d">
    <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
      <h2 className="u-text u-text-default u-text-1">Burger Menu</h2>
      <p className="u-text u-text-2">
      ...
      <div className="u-list u-list-1">
        <div className="u-repeater u-repeater-1">
          ...
          >
            <div className="u-container-layout u-similar-container u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-1">
              <div className="u-align-center u-black u-container-style u-group u-opacity u-opacity-35 u-video-cover u-group-1">
                <div className="u-container-layout u-valign-middle u-container-layout-2">
                  <h4 className="u-text u-text-3">Double Burger</h4>
          ...
          >
            <div className="u-container-layout u-similar-container u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-3">
              <div className="u-align-center u-black u-container-style u-group u-opacity u-opacity-35 u-video-cover u-group-2">
                <div className="u-container-layout u-valign-middle u-container-layout-4">
                  <h4 className="u-text u-text-5">Farm House</h4>
                  <h6 className="u-text u-text-default u-text-palette-2-light-1 u-text-6">
                    $7.50
                  </h6>
                  <a
                    href="https://nicepage.com/k/projects-website-templates"
          ...
          <div
            ...
            data-image-height={389}
          >
            <div className="u-container-layout u-similar-container u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-7">
              <div className="u-align-center u-black u-container-style u-group u-opacity u-opacity-35 u-video-cover u-group-4">
                <div className="u-container-layout u-valign-middle u-container-layout-8">
                  ...
                  <a
                    href="https://nicepage.com/k/membership-website-templates"
          ...
          <div
            className="u-align-right u-container-style u-image u-list-item u-repeater-item u-shading u-video-cover u-image-5"
            data-image-width={996}
            data-image-height={389}
          >
            <div className="u-container-layout u-similar-container u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-9">
              <div className="u-align-center u-black u-container-style u-group u-opacity u-opacity-35 u-video-cover u-group-5">
                <div className="u-container-layout u-valign-middle u-container-layout-10">
                  <h4 className="u-text u-text-default u-text-11">
                    Black Burger
                  </h4>
                  <h6 className="u-text u-text-default u-text-palette-2-light-1 u-text-12">
                    $11.00
                  </h6>
                  <a
                    href="https://nicepage.com/c/table-html-templates"
                    className="u-active-palette-2-light-1 u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-light-1 u-palette-2-base u-radius-50 u-btn-5"
                  >
                    add to cart
                  </a>
                </div>
          ...
          <div
            className="u-align-right u-container-style u-image u-list-item u-repeater-item u-shading u-video-cover u-image-6"
            data-image-width={996}
            data-image-height={389}
          >
            <div className="u-container-layout u-similar-container u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-11">
              <div className="u-align-center u-black u-container-style u-group u-opacity u-opacity-35 u-video-cover u-group-6">
                <div className="u-container-layout u-valign-middle u-container-layout-12">
                  <h4 className="u-text u-text-default u-text-13">
                    King Burger
                  </h4>
                  <h6 className="u-text u-text-default u-text-palette-2-light-1 u-text-14">
                    $11.00
                  </h6>
                  <a
                    href="https://nicepage.com/c/sports-website-templates"
                    className="u-active-palette-2-light-1 u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-light-1 u-palette-2-base u-radius-50 u-btn-6"
                  >
                    add to cart
                  </a>
                </div>
      ...
      <p className="u-text u-text-default u-text-15">
        Images from{" "}
        <a
          href="https://www.freepik.com/photos/food"
          className="u-active-none u-border-1 u-border-active-palette-2-base u-border-black u-border-hover-palette-2-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-7"
        >
          Freepik
        </a>
      </p>
  ...
  <section
    className="u-align-center u-clearfix u-image u-valign-middle u-section-7"
    id="carousel_31c9"
  >
    <div
      id="carousel-5989"
    ...
    >
      ...
      <div className="u-carousel-inner" role="listbox">
        <div className="u-active u-carousel-item u-container-style u-slide u-white u-carousel-item-1">
          <div className="u-container-layout u-valign-middle u-container-layout-1">
            ...
            <a
              ...
              className="u-border-2 u-border-active-black u-border-hover-palette-2-base u-border-palette-2-base u-btn u-btn-round u-button-style u-none u-radius-50 u-text-body-color u-btn-1"
            >
              view menu
            </a>
          </div>
        </div>
        <div className="u-carousel-item u-container-style u-slide u-white u-carousel-item-2">
          <div className="u-container-layout u-valign-middle u-container-layout-2">
            <span className="u-file-icon u-icon u-icon-rectangle u-text-palette-2-base u-icon-2">
              <img src="images/4901389-f399d837.png" alt="" />
            </span>
            <h4 className="u-align-center u-text u-text-default u-text-3">
              Burgers
              <br />
            </h4>
            <p className="u-align-center u-large-text u-text u-text-variant u-text-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
              enim ad minim veniam, quis nostrud exercitation ullamco laboris
            </p>
            <a
              href="https://nicepage.cloud"
              className="u-border-2 u-border-active-black u-border-hover-palette-2-base u-border-palette-2-base u-btn u-btn-round u-button-style u-none u-radius-50 u-text-body-color u-btn-2"
            >
              view menu
            </a>
          </div>
      ...
      <a
        className="u-absolute-vcenter u-carousel-control u-carousel-control-prev u-grey-5 u-hidden-xs u-spacing-13 u-text-grey-40 u-carousel-control-1"
        href="#carousel-5989"
        role="button"
        data-u-slide="prev"
      >
      ...
      <a
        className="u-absolute-vcenter u-carousel-control u-carousel-control-next u-grey-5 u-hidden-xs u-spacing-13 u-text-grey-40 u-carousel-control-2"
        href="#carousel-5989"
        role="button"
        data-u-slide="next"
      >
    ...
    <p className="u-align-left u-text u-text-body-alt-color u-text-5">
      Image from{" "}
      <a
        href="https://www.freepik.com/photos/food"
        className="u-border-2 u-border-palette-2-base u-btn u-button-style u-none u-text-body-alt-color u-btn-3"
      >
        Freepik
      </a>
    </p>
  </section>
  <section className="u-clearfix u-section-8" id="carousel_886a">
    <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
      <div className="u-palette-2-base u-shape u-shape-circle u-shape-1" />
      <div className="u-shape u-shape-svg u-text-palette-2-base u-shape-2">
        <svg
          className="u-svg-link"
          preserveAspectRatio="none"
          viewBox="0 0 160 160"
	...
	C80.2,0,80.1,0,80,0z"
        ...
        <div className="u-container-layout u-valign-top u-container-layout-1">
          ...
          <p className="u-text u-text-3">
            ...
            <a
              ...
              className="u-active-none u-border-1 u-border-active-palette-2-base u-border-black u-border-hover-palette-2-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-1"
            >
              Freepik
            </a>
          </p>
      ...
      />
      <div
        className="u-border-7 u-border-white u-image u-image-circle u-image-2"
        data-image-width={626}
        data-image-height={417}
      />
    </div>
  ...
  <section
    ...
    id="carousel_8a37"
  >
    <div className="u-clearfix u-sheet u-valign-middle-md u-valign-middle-xl u-sheet-1">
      <div className="u-expanded-height-lg u-expanded-height-xl u-palette-2-base u-shape u-shape-rectangle u-shape-1" />
                        ...
                        <div className="u-expanded-width u-form u-form-1">
                          ...
                          >
                            ...
                            <input
                              type="hidden"
                              name="formServices"
                              defaultValue="e8f404a03bd3b2d8955acb96773e5d30"
                            />
                          </form>
                        </div>
                      </div>
                    ...
                    <div className="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-container-style u-layout-cell u-size-30 u-layout-cell-4">
                      <div className="u-container-layout u-valign-middle u-container-layout-4">
                        ...
                        <div className="u-social-icons u-spacing-20 u-social-icons-1">
                          ...
                          <a className="u-social-url" target="_blank" href="">
                            <span className="u-icon u-icon-circle u-social-google u-social-icon u-icon-4">
                              <svg
                                className="u-svg-link"
                                preserveAspectRatio="xMidYMin slice"
                                viewBox="0 0 112.2 112.2"
                        ...
                        <p className="u-text u-text-6">
                          ...
                          <a
                            ...
                            className="u-active-none u-border-2 u-border-active-palette-2-base u-border-hover-palette-2-base u-border-no-left u-border-no-right u-border-no-top u-border-white u-btn u-button-link u-button-style u-hover-none u-none u-text-body-alt-color u-btn-2"
                          >
                            Freepik
                          </a>
                        </p>
                        <p className="u-text u-text-7">©2020 Privacy policy</p>
                      </div>
                    </div>
                  </div>
                </div>
